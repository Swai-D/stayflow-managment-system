...
import { formatTZS, formatTZSShort } from '@/lib/formatters'
...
// ── Mock data — TODO: replace with useStoreDashboard() hook ─────────────────
const MOCK = {
  totalItems: 17, lowStockCount: 3, outOfStockCount: 0,
  monthlySpend: 485000, pendingPOs: 2,
  topUsedItems: [
    { item: { id:'1', name:'Serengeti Beer',  unit:'BOTTLE' } as any, totalUsed: 48 },
    { item: { id:'2', name:'Mineral Water',   unit:'BOTTLE' } as any, totalUsed: 40 },
    { item: { id:'3', name:'Coca Cola',       unit:'BOTTLE' } as any, totalUsed: 35 },
    { item: { id:'4', name:'Breakfast Plate', unit:'PCS'    } as any, totalUsed: 28 },
    { item: { id:'5', name:'Chips (Portion)', unit:'PCS'    } as any, totalUsed: 22 },
  ],
  recentTransactions: [
    { id:'t1', type:'STOCK_IN',  item:{ name:'Serengeti Beer' } as any, quantity:24, createdAt:new Date().toISOString(), performedBy:{ fullName:'Rehema Khamis' }, balanceBefore:24, balanceAfter:48 },
    { id:'t2', type:'STOCK_OUT', item:{ name:'Mineral Water' }  as any, quantity:6,  createdAt:new Date().toISOString(), performedBy:{ fullName:'Juma Salim'    }, balanceBefore:46, balanceAfter:40 },
    { id:'t3', type:'STOCK_OUT', item:{ name:'Shower Gel' }     as any, quantity:4,  createdAt:new Date().toISOString(), performedBy:{ fullName:'Grace Nyanda'  }, balanceBefore:12, balanceAfter:8  },
    { id:'t4', type:'WASTAGE',   item:{ name:'Fresh Juice' }    as any, quantity:2,  createdAt:new Date().toISOString(), performedBy:{ fullName:'Rehema Khamis' }, balanceBefore:22, balanceAfter:20 },
    { id:'t5', type:'STOCK_IN',  item:{ name:'Toilet Paper' }   as any, quantity:12, createdAt:new Date().toISOString(), performedBy:{ fullName:'Juma Salim'    }, balanceBefore:18, balanceAfter:30 },
  ] as any[],
  lowStockItems: [
    { id:'s1', name:'Shower Gel (50ml)',   currentStock:8,  minimumStock:20, unit:'PCS',  subCategory:'Bathroom Amenities' } as any,
    { id:'s2', name:'Toilet Soap (bar)',   currentStock:15, minimumStock:20, unit:'PCS',  subCategory:'Bathroom Amenities' } as any,
    { id:'s3', name:'Garbage Bags (roll)', currentStock:5,  minimumStock:6,  unit:'ROLL', subCategory:'Cleaning Supplies'  } as any,
  ] as any[],
}

const SPEND_TREND = [
  { month:'Jan', fb:180000, hotel:95000  }, { month:'Feb', fb:220000, hotel:110000 },
  { month:'Mar', fb:195000, hotel:88000  }, { month:'Apr', fb:240000, hotel:102000 },
  { month:'May', fb:210000, hotel:95000  }, { month:'Jun', fb:260000, hotel:115000 },
]
...
export default function StoreDashboardPage() {
  // TODO: const { data: stats, isLoading } = useStoreDashboard()
  const stats = MOCK
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.07)]">
          ...
          <div className="h-[190px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={SPEND_TREND} margin={{top:4,right:4,left:-28,bottom:0}}>
